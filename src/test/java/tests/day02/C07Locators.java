...
public class C07Locators {     static WebDriver driver;
 ...
 /*   static WebDriver driver;
    ...
    static void setUp() {
        ...
        public void testLoginElements(){
            ...
            passField.sendKeys(testPass);
            //WebElement signInButton = driver.findElement(By.xpath("//button[text(),'تسجيل الدخول ']")).click();
            WebElement signInButton = driver.findElement(By.xpath("//button[contains(text(),'تسجيل الدخول')]"));
